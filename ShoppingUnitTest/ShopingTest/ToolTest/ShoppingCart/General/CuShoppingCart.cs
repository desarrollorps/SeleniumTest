...
namespace SeleniumGeneratedClasses.ToolTest.ShoppingCart.Services.General
{
    ...
    public partial class CuShoppingCartView : View
    {
         ...
         public void InitializeControls()
        {
            ...
            ConfirmDeleteButton = RPSControlFactory.RPSConfirmDeleteButton<CuShoppingCartView>( this);
        ...
        public IRPSButton<CuShoppingCartView> ConfirmDeleteButton { get; set; } 
    ...
    public partial class CuShoppingCartLineView : View
    {
         ...
         public void InitializeControls()
        {
            ...
            ConfirmDeleteButton = RPSControlFactory.RPSConfirmDeleteButton<CuShoppingCartLineView>( this);
        ...
        public IRPSButton<CuShoppingCartLineView> ConfirmDeleteButton { get; set; } 
